...
const Navbar = () => {
    ...
    return (
        <div className={`w-full h-20 z-10 fixed bg-white text-black duration-300 ease-in ${pageScroll && 'bg-black text-[#FFF]'}`}>
            <div className='flex justify-between items-center w-full h-full max-w-screen-xl mx-auto p-4'>
                <Link href="/#home">
                    <h1 onClick={() => setNavigation(false)} className="text-3xl lg:text-4xl font-bold uppercase underline underline-offset-2 tracking-wider cursor-pointer">vinay</h1>
                </Link>
                    ...
                    <ul className='hidden md:flex'>
                        {links.map(({ id, link }) => (
                            <Link key={id} href={`/#${link}`}>
                                <li className="ml-10 text-sm uppercase cursor-pointer duration-200 ease-out hover:scale-105 tracking-wider">{link}</li>
                            </Link>
                        ))}
                    </ul>
                ...
                <div className={navigation ? "fixed left-0 top-0 w-4/5 h-full bg-gradient-to-r from-blue-600 to-cyan-600 text-white p-10 ease-in duration-500" : "fixed top-0 left-[-100%] p-10 h-full ease-in duration-500"}>
                    ...
                    <div>
                        <div className='flex w-full items-center justify-between'>
                            <Link href="/#home">
                                <h2 className='text-3xl font-bold uppercase underline underline-offset-2 tracking-wider cursor-pointer'>vinay</h2>
                            </Link>
                    ...
                    <div className="mt-24 flex flex-col h-fit gap-20">
                        ...
                        <div>
                            <div className='grid grid-cols-2 mx-auto w-4/5 gap-10'>
                                ...
                                <div className='flex items-center justify-center rounded-full shadow-md shadow-white p-3 cursor-pointer'>
                                    <FaTwitter size={30} />
                                </div><div className='flex items-center justify-center rounded-full shadow-md shadow-white p-3 cursor-pointer'>
                                    <FaFacebook size={30} />
                                </div><div className='flex items-center justify-center rounded-full shadow-md shadow-white p-3 cursor-pointer'>
                                    <FaGithub size={30} />
                                </div>
